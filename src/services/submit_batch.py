...
#   4. Create batch DB record (status: queued)
#   5. Create candidate records for each unique file (status: new)
#   6. Store all files to storage
#   7. Enqueue Celery process_batch task
#   8. Return Batch entity
# """
...
#         from src.tasks.process_batch_task import process_batch
